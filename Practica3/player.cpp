...
double posibilidadFilas(const Environment &estado, int jugador){
    ...
    for(int i=0; i<7 && vacios!=7; i++){
        ...
        for(int j=0; j<7 && vacios!=7; j++){
            ...
            else if(casilla == jugador || casilla == jugador+3){
                contadorJug++;
                suma += contadorCont;
                contadorCont = 0;
            }
...
double posibilidadColumnas(const Environment &estado, int jugador){
    ...
    for(int i=0; i<7; i++){
        contadorJug = 0;
        contadorCont = 0;
        int casilla = estado.See_Casilla(0, i);
        for(int j=0; j<7 && casilla!=0; j++){
            casilla = estado.See_Casilla(j,i);
            if(casilla == jugador || casilla == jugador+3){
                contadorJug++;
                suma += contadorCont;
                contadorCont = 0;
            }
...
double posibilidadDiagonales(const Environment &estado, int jugador){
    int contadorJug = 0,
        contadorCont = 0;
    double suma = 0;
    ...
    for(int i=3; i>=0; i--){
        ...
        contadorCont = 0;
        while(aux1<=6){
            int casilla = estado.See_Casilla(aux1,j);
            if(casilla == 0){
                suma -= contadorJug;
                suma += contadorCont;
                contadorJug = 0;
    ...
    for(int i=1; i<=3; i++){
        ...
        contadorCont = 0;
        while(aux1<=6){
            int casilla = estado.See_Casilla(j,aux1);
            if(casilla == 0){
                suma -= contadorJug;
                suma += contadorCont;
                contadorJug = 0;
...
double Heuristica(const Environment &estado, int jugador){
    ...
    valor += posibilidadFilas(estado, jugador);
    valor += posibilidadColumnas(estado, jugador);
    valor += posibilidadDiagonales(estado, jugador);
